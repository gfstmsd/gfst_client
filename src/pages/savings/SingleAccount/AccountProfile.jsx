...
// import {formatDateOnly, formatDateTime } from '../../../util/FormatDate';
...
//         <p>Date of Birth: <strong>{formatDateOnly(accountDetails.dob)}</strong></p>
            ...
            {transactions.length > 0 ? (() => {
              ...
              return sortedTransactions.map((transaction) => {
                const isCredit =
                  ...
                  transaction.typeOfTransaction === 'transfer_credit';
                const isDebit =
                  transaction.typeOfTransaction === 'withdraw' ||
                  transaction.typeOfTransaction === 'transfer_debit';
